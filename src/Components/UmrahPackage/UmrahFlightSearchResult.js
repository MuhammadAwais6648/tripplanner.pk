                  ...
                  <div className="col-lg-10 col-md-12">
                      ...
                      <div className="col-lg-2 col-md-12">
                        <div className="flight-fare mt-lg-4 mt-md-4 mt-2 mb-2">
                          ...
                          <Link to="/umrah-selected-flight"><button className="view-btn w-100" type="submit">Select This</button></Link>
                        </div>
                      </div>
                  </div>
                </div>
...
export default UmrahFlightSearchResult;