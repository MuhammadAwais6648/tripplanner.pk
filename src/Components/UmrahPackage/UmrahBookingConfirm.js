                ...
                <div className="right-bar p-5 mt-5 flight-detail booking-detail">
                  ...
                  <div className="confrim-chk mt-4">
                   ...
                   <div className="book-now mt-4">
                    <button><a className="view-btn1 mt-4" href="#myModal" className="trigger-btn" data-toggle="modal">Pay & Book</a></button>
                   </div>
...
export default UmrahBookingConfirm;