...
const UmrahTransportDetail = () => {
useEffect(() => {
  window.scrollTo(0, 0);
   document.title = "Transport Detail | Tripplanner ";
}, [])
return(
<div>
<BlackNavbar />
...
<section className="flight-found hotel-detail-right-bar">
            ...
            <div className="row mt-5">
              ...
              <div className="col-lg-3 col-md-3 d-none d-lg-block">
                <div className="left-bar-tour-pack p-3">
                  ...
                  <div className="sub-txt for-green-color mt-3"> <i className="fas fa-check mr-1"></i> <strong>Pay Now</strong> </div>
                  <div className="sub-txt pl-3">Total includes taxes and fees</div>
                  <div className="benifits mt-4 mb-4">
                  <ul className="p-0">
                      <li className="pb-1"> <i className="fas fa-check mr-1"></i> Free cancellation up to 6 hours before pick-up</li>
                      <li className="pb-1"> <i className="fas fa-check mr-1"></i> Zero Excess Damage Protection available</li>
                      <li> <i className="fas fa-check mr-1"></i> Enhanced cleaning</li>
                  </ul>
                  </div>
                </div>
                </div>
          ...
          <div className="col-lg-9 col-md-12">
            ...
            <div className="book-now">
              <Link to="/umrah-flight-search-result"><button className="view-btn mt-4" type="submit">Continue Booking</button></Link>
            </div>
          </div>
...
export default UmrahTransportDetail;