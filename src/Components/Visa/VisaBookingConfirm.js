...
const VisaBookingConfirm = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Booking Confirm | Tripplanner PK";
  }, [])
                ...
                <div className="modal-dialog modal-confirm">
                  <div className="modal-content">
                    ...
                    <div className="modal-footer">
                      ...
                      <button className="btn btn-success modal-close-btn btn-block " >OK</button>
...
export default VisaBookingConfirm;