 ...
 <section className="search-flight mt-5">
          ...
          <div className="row mb-3 m-0">
              <div className="col-lg-12 col-md-12 col-12">
                <div className="g-3 needs-validation main-search bot-search-eng p-4 mt-2" novalidate>
                      ...
                      <div className="room-detail car-detail mt-3">
                        <div className="row">
                          ...
                          <div className="col-lg-4 col-md-4 col-sm-4 col-12">
                              ...
                              <div className="text-center"><Link to="/Business-GMC"><button className="view-btn" type="submit">Check Availability</button></Link></div>
                        </div>
                          </div>
                        </div>
                      </div>
