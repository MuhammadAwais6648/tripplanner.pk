...
const BlackNavbar = () => {
  ...
  return (
    <div id="page-wrap">
      ...
      <nav className={colorChange ? 'navbar navbar-expand-lg navbar-light fixed-top navbar1 colorChange' : 'navbar1 colorChange navbar navbar-expand-lg navbar-light fixed-top'} id="mainNav">
          ...
          <div className="row custom-width custom-nav">
            <div className="col-lg-5 col-4">
              ...
              <div className="top-menu d-lg-inline d-none">
                ...
                <Link to="/flight" className="nav-link pl-2">Flight</Link>
                <Link to="/umrah" className="nav-link pl-2">Umrah</Link>
              ...
              <div className="side-inner">
                <div className="nav-menu">
                  <ul>
                    ...
                    {/*     <li><a className="nav-link1 pl-3" onClick={Theme}>{themeText}</a></li>  */}
                  </ul>
                </div>
              </div>
            </aside>
